...
* Buď sada **Hardwario Radio CO₂ Monitor Kit**, nebo jednotlivé komponenty:
  
	* 1× **Hardwario Core Module**
	* 1× **Hardwario Temperature Tag**
	* 1× **Hardwario Humidity Tag**
	* 1× **Hardwario Barometer Tag**
	* 1× **Hardwario CO₂ Module**
	* 1× **Hardwario Battery Module**
	* 1× **Hardwario Radio Dongle**
...
V tomto bodě máte navázané rádiové spojení mezi uzlem \(**Radio Motion Detector**\) a bránou \(**Radio Dongle**\).
...
### SKrok 5: Stáhněte si aplikaci **Blynk** z [**App Store**](https://itunes.apple.com/us/app/blynk-iot-for-arduino-esp32/id808760481?mt=8) nebo [**Google Play**](https://play.google.com/store/apps/details?id=cc.blynk&hl=en)
