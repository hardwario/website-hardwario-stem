...
### <a id="requirements">Požadavky</a>

* Buď **HARDWARIO Sada Control**, nebo jednotlivé komponenty:
  * 1x **HARDWARIO Cover Module**
  * 1x **HARDWARIO Core Module**
  * 1x **HARDWARIO Power Module**
  * 1× AC/DC adaptér 5 V/3 A (nebo vyšší proudový limit)
  * 1× 3D tištěná krabička BCE301
  
* Ostatní komponenty:
  * 1× **HARDWARIO Radio Dongle** (není součástí sady)
...
### <a id="firmware-upload">Nahrání firmwaru </a>
