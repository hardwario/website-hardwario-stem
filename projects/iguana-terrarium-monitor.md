...
If you already have the Starter Kit, you will only need the [Climate Module](https://shop.hardwario.com/p/climate-module/). Alternatively, the [Clime Set](https://www.hardwario.store/p/clime-set) contains **all the equipment** you need.
