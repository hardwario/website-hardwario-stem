...
<div class="container">
  <div class="row">
    <Image img={require('/iot-lessons/img/iot-LED.webp')}/>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <Image img={require('/iot-lessons/img/iot-function_LED1.webp')}/>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <Image img={require('/iot-lessons/img/iot-function_LED2.webp')}/>
  </div>
</div>